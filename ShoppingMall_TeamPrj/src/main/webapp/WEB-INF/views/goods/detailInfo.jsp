...
<div class="product-detail-container">
	...
	<div class="product-info">
		<div>
			상품명: <strong>${goods.product_name}</strong>
		</div>
		<div>
			가격: <span class="price">${goods.price}</span> 원
		</div>
	...
	<div class="cart-form">
		<form id="addCartForm" method="post"
			action="${contextPath}/cart/addMyCart.do">
	...
	<div class="product-description">
		<h2>상품 상세 정보</h2>
		<p>이 상품은 고품질 소재로 제작되었으며, 최신 트렌드를 반영한 디자인을 자랑합니다. 자세한 사양은 추후 업데이트
			예정입니다.</p>
	</div>
			...
			function() {
						...
						function(e) {
							...
							$.ajax({
								...
								success : function(response) {
									// response가 "add_success" 또는 "quantity_updated", "login_required" 등의 단순 문자열임
				...
				$(".tab-btn").click(
						function() {
							...
							$(".tab-content").removeClass("active").fadeOut(
									300,
									function() {
										$("#" + tabId).fadeIn(300).addClass(
												"active");
									});
						});
			});
